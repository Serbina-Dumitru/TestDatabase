  ...
  public static void Seed(Context _context)
  {
    ...
    if (!_context.Users.Any())
    {
      users.AddRange(
          ...
          new() { UserID = 5, Username = "emily", Password = "EmilyPass123", Email = "emily@example.com", IsOnline = false, SessionToken = "token-emily", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/emily.jpg" },
          new() { UserID = 6, Username = "frank", Password = "FrankPass123", Email = "frank@example.com", IsOnline = true, SessionToken = "token-frank", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/frank.jpg" },
          new() { UserID = 7, Username = "grace", Password = "GracePass123", Email = "grace@example.com", IsOnline = true, SessionToken = "token-grace", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/grace.jpg" },
          new() { UserID = 8, Username = "henry", Password = "HenryPass123", Email = "henry@example.com", IsOnline = false, SessionToken = "token-henry", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/henry.jpg" },
          new() { UserID = 9, Username = "isabel", Password = "IsabelPass123", Email = "isabel@example.com", IsOnline = true, SessionToken = "token-isabel", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/isabel.jpg" },
          new() { UserID = 10, Username = "jack", Password = "JackPass123", Email = "jack@example.com", IsOnline = true, SessionToken = "token-jack", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/jack.jpg" }
          );
