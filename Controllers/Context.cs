...
public class Context : DbContext
{
  ...
  public static void Seed(Context _context)
  {
    ...
    {
      users.AddRange(
          new() { UserID = 1, Username = "alice", Password = "AlicePass123",  IsOnline = true, IsAccountDeleted = false, LastTimeOnline = DateTime.UtcNow, SessionToken = "token-alice", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/alice.jpg" },
          new() { UserID = 2, Username = "bob", Password = "BobPass123",  IsOnline = false, IsAccountDeleted = false,  LastTimeOnline = DateTime.UtcNow,SessionToken = "token-bob", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/bob.jpg" },
          new() { UserID = 3, Username = "carla", Password = "CarlaPass123",  IsOnline = true, IsAccountDeleted = false,  LastTimeOnline = DateTime.UtcNow,SessionToken = "token-carla", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/carla.jpg" },
          new() { UserID = 4, Username = "daniel", Password = "DanielPass123",  IsOnline = true, IsAccountDeleted = false,  LastTimeOnline = DateTime.UtcNow,SessionToken = "token-daniel", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/daniel.jpg" },
          new() { UserID = 5, Username = "emily", Password = "EmilyPass123", IsOnline = false, IsAccountDeleted = false, LastTimeOnline = DateTime.UtcNow, SessionToken = "token-emily", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/emily.jpg" },
          new() { UserID = 6, Username = "frank", Password = "FrankPass123",  IsOnline = true, IsAccountDeleted = false, LastTimeOnline = DateTime.UtcNow, SessionToken = "token-frank", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/frank.jpg" },
          new() { UserID = 7, Username = "grace", Password = "GracePass123",  IsOnline = true, IsAccountDeleted = false, LastTimeOnline = DateTime.UtcNow, SessionToken = "token-grace", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/grace.jpg" },
          new() { UserID = 8, Username = "henry", Password = "HenryPass123",  IsOnline = false, IsAccountDeleted = false, LastTimeOnline = DateTime.UtcNow, SessionToken = "token-henry", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/henry.jpg" },
          new() { UserID = 9, Username = "isabel", Password = "IsabelPass123",  IsOnline = true, IsAccountDeleted = false, LastTimeOnline = DateTime.UtcNow, SessionToken = "token-isabel", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/isabel.jpg" },
          new() { UserID = 10, Username = "jack", Password = "JackPass123", IsOnline = true, IsAccountDeleted = false, LastTimeOnline = DateTime.UtcNow, SessionToken = "token-jack", SessionTokenExpirationDate = DateTime.UtcNow.AddDays(1), UserProfilePicturePath = "images/profiles/jack.jpg" }
          );
